...
date: 03/05/2021
added:
1. this is for order confirmation
-->
<head>
                ...
                <tr>
                  <td align="left" valign="top">
                    <font face="'Nunito', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                      <span style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">尊敬的 {$user->user_name} 先生/女士</span>
                    </font>
